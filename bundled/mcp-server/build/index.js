...
// ── Import tool modules ────────────────────────────────────────────────
import { toolDefinitions as wpcliTools, handleTool as handleWpcliTool, } from './tools/wpcli.js';
import { toolDefinitions as logTools, handleTool as handleLogTool, } from './tools/logs.js';
import { toolDefinitions as configTools, handleTool as handleConfigTool, } from './tools/config.js';
import { toolDefinitions as siteTools, handleTool as handleSiteTool, } from './tools/site.js';
import { toolDefinitions as environmentTools, handleTool as handleEnvironmentTool, } from './tools/environment.js';
// ── Aggregate all tools ────────────────────────────────────────────────
const allTools = [
    ...wpcliTools,
    ...logTools,
