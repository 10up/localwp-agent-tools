...
function handleGetSiteInfo(config) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // Get PHP version
        try {
            const { stdout } = yield execFileAsync(config.phpBin, ['-v'], {
                timeout: 5000,
                env: Object.assign(Object.assign({}, process.env), (0, paths_1.getPhpEnvironment)(config.phpBin)),
            });
        ...
        if (config.wpCliBin && (0, fs_1.existsSync)(config.wpCliBin)) {
            ...
            try {
                const { stdout: pluginOut } = yield execFileAsync(config.phpBin, wpCliArgs(['plugin', 'list', '--status=active', '--format=json']), { cwd: config.wpPath, timeout: 15000, env: (0, utils_1.buildWpCliEnv)(config) });
            ...
            try {
                const { stdout: themeOut } = yield execFileAsync(config.phpBin, wpCliArgs(['theme', 'list', '--status=active', '--format=json']), { cwd: config.wpPath, timeout: 15000, env: (0, utils_1.buildWpCliEnv)(config) });
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (config.wpCliBin && (0, fs_1.existsSync)(config.wpCliBin)) {
            try {
                ...
                yield execFileAsync(config.phpBin, wpCliArgs, { cwd: config.wpPath, timeout: 15000, env: (0, utils_1.buildWpCliEnv)(config) });
                const countArgs = [];
                if (config.dbSocket) {
                ...
                const { stdout: countOut } = yield execFileAsync(config.phpBin, countArgs, { cwd: config.wpPath, timeout: 15000, env: (0, utils_1.buildWpCliEnv)(config) });
