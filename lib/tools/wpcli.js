...
function runWpCli(wpArgs, config, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const envPath = mysqlBinDir
            ...
            : process.env.PATH || '';
        const env = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, process.env), (0, paths_1.getPhpEnvironment)(config.phpBin)), { PHP: config.phpBin, PATH: envPath }), (config.dbSocket ? { MYSQL_UNIX_PORT: config.dbSocket } : {})), (config.dbHost ? { MYSQL_HOST: config.dbHost } : {})), (config.dbPort ? { MYSQL_TCP_PORT: String(config.dbPort) } : {})), { MYSQL_PWD: config.dbPassword || '', DB_HOST: config.dbHost || 'localhost', DB_USER: config.dbUser || 'root', DB_PASSWORD: config.dbPassword || 'root', DB_NAME: config.dbName || 'local' }), (config.dbSocket ? { DB_SOCKET: config.dbSocket } : {})), (config.dbPort ? { DB_PORT: String(config.dbPort) } : {}));
