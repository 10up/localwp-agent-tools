...
exports.setWpConstant = setWpConstant;
exports.parsePhpErrorLine = parsePhpErrorLine;
...
function readLogTail(filePath) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const fd = yield (0, promises_1.open)(filePath, 'r');
        try {
            const offset = fileStat.size - MAX_LOG_READ_SIZE;
            const buffer = Buffer.alloc(MAX_LOG_READ_SIZE);
            yield fd.read(buffer, 0, MAX_LOG_READ_SIZE, offset);
...
function handleReadErrorLog(args, config) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const content = yield readLogTail(logFile);
